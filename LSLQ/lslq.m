function [x, xcg, flag, it, normr, normAr, resvec, resvecAr, errvec, errveccg] = ...
    lslq( A, b, atol, btol, etol, conlim, maxit, lambda, sigma )
...
%
%   X = LSLQ(A,B,ATOL,BTOL,ETOL,...,SIGMA) continues iterations until a
...
%   NORM(A'*(B-A*X0)).
%
%   [X,XCG,FLAG,ITER,NORMR,NORMAR,RESVEC,RESVECAR,ERRVEC] = LSLQ(A,B,...)
